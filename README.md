...
| **B** | [`b_gymnast_photo.png`](assets/b_gymnast_photo.png), [`silhouettes/b.png`](assets/silhouettes/b.png) | From behind: standing leg and torso the stem, hand-on-hip elbow the upper bowl, bent knee the lower bowl. |
| **C** | [`c_gymnast_photo.png`](assets/c_gymnast_photo.png), [`silhouettes/c.png`](assets/silhouettes/c.png) | Kneeling backbend, thighs the left stem, arched torso and thrown-back head opening right. |
...
| **F** | [`f_gymnast_photo.png`](assets/f_gymnast_photo.png), [`silhouettes/f.png`](assets/silhouettes/f.png) | Standing on one straight leg; both arms the top bar; folded lifted leg the middle bar. |
...
| **H** | [`h_gymnast_photo.png`](assets/h_gymnast_photo.png), [`silhouettes/h.png`](assets/silhouettes/h.png) | Horizontal torso the crossbar; raised leg and kneeling shin the left stem; raised and planted arms the right stem. |
...
| **J** | [`j_gymnast_photo.png`](assets/j_gymnast_photo.png), [`silhouettes/j.png`](assets/silhouettes/j.png) | Joined legs the tall right stem, flexed feet a short top serif, hips/back/arms the open bottom hook, upright profile head the lower-left terminal. |
...
| **N** | [`n_poster_crop.png`](assets/n_poster_crop.png), [`silhouettes/n.png`](assets/silhouettes/n.png) | Planted arm the left stem, organic torso the diagonal, raised leg the right stem. |
| **O** | [`o_gymnast_photo.png`](assets/o_gymnast_photo.png), [`silhouettes/o.png`](assets/silhouettes/o.png) | Full bow whose raised feet and grasping arms close a ring, with a large natural counter. |
| **P** | [`p_gymnast_photo.png`](assets/p_gymnast_photo.png), [`silhouettes/p.png`](assets/silhouettes/p.png) | Standing backbend: planted legs the stem; arched torso, hanging head, and clasped hands the bowl. |
| **Q** | [`q_gymnast_photo.png`](assets/q_gymnast_photo.png), [`silhouettes/q.png`](assets/silhouettes/q.png) | Prone bow: raised feet and grasping arm close the ring; the other arm plants as the tail. |
| **R** | [`r_gymnast_photo.png`](assets/r_gymnast_photo.png), [`silhouettes/r.png`](assets/silhouettes/r.png) | The same standing backbend as P, with the front leg stepped forward as the diagonal. |
| **S** | [`s_gymnast_photo.png`](assets/s_gymnast_photo.png), [`silhouettes/s.png`](assets/silhouettes/s.png) | Grounded shins the lower terminal, backbend and head the middle curve, overlapped arms the upper hook. |
...
| **V** | [`v_gymnast_photo.png`](assets/v_gymnast_photo.png), [`silhouettes/v.png`](assets/silhouettes/v.png) | Two equal legs rise from a compact buttocks apex; outward-turned shod feet are the upper terminals. |
| **W** | [`w_gymnast_photo.png`](assets/w_gymnast_photo.png), [`silhouettes/w.png`](assets/silhouettes/w.png) | Head and shoulders the centre peak, arms overlapping thighs as inner strokes, shorter slimmer calves as outer strokes. Hands conceal the grounded knees; pointed feet turn modestly outward. One contour, no carved notch. |
| **X** | [`x_gymnast_photo.png`](assets/x_gymnast_photo.png), [`silhouettes/x.png`](assets/silhouettes/x.png) | Wide forward fold from behind: legs an inverted V, head hanging at the centre, arms to the upper corners. |
| **Y** | [`y_gymnast_photo.png`](assets/y_gymnast_photo.png), [`silhouettes/y.png`](assets/silhouettes/y.png) | Headstand: torso the stem, split legs the V. |
