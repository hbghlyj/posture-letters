...
- **L:** rebuilt as an upright seated posture. The spine is straight and strictly vertical, perpendicular to the ground, with the head facing forward in line with it. Both legs extend fully straight ahead along the floor to form the horizontal baseline, feet together and flexed square so the toes point up. Instead of resting at the hips, the arms are raised completely overhead parallel to the spine, spreading slightly apart, ending in wide-open palms with the fingers pointing at the ceiling.
