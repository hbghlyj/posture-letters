...
| J | **FAIL** | L 250.3, L 250.3, L 451.7, L 497.9 | 332.0 | 110.0 | limb 1 (leg) total 250.3 is -15.2% from 295.2 |
| K | **FAIL** | L 294.0, L 290.0, L 308.3, L 338.0 | 92.1 | 110.0 | limb 2 thigh 143.0 is -5.8% from 151.8 |
| L | **FAIL** | A 216.3, A 216.3, L 619.4, L 590.1 | 242.0 | 110.0 | limb 1 (arm) total 216.3 is +9.3% from 197.8 |
...
| Z | **FAIL** | L 400.0, L 382.0, L 428.6, L 426.9 | 613.6 | 110.0 | limb 1 (leg) total 400.0 is +35.5% from 295.2 |
...
- limb 3 (leg) total 451.7 is +53.0% from 295.2
- limb 3 has 3 skeletal segments; expected upper/lower pair
- limb 4 (leg) total 497.9 is +68.6% from 295.2
...
- limb 3 has 3 skeletal segments; expected upper/lower pair
- limb 4 (leg) total 590.2 is +99.9% from 295.2
- limb 4 has 3 skeletal segments; expected upper/lower pair
...
- limb 3 has 3 skeletal segments; expected upper/lower pair
- limb 4 (leg) total 426.9 is +44.6% from 295.2
- limb 4 has 3 skeletal segments; expected upper/lower pair
