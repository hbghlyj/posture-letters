...
| F | **FAIL** | A 410.6, A 289.0, A 370.2, A 370.2 | 250.0 | 110.0 | limb 1 (arm) total 410.6 is +23.5% from 332.5 |
| G | **FAIL** | L 721.6, A 412.0, L 429.6, A 308.8 | 423.6 | 96.0 | limb 1 (leg) total 721.6 is +19.1% from 605.7 |
| H | **FAIL** | A 235.0, A 390.2, A 390.0, A 235.0, A 390.2, A 390.0 | 206.2, 206.2 | 110.0, 110.0 | expected 4 measurable limbs; found 6 |
| I | **FAIL** | A 240.3, A 240.3, A 340.1, A 340.1 | 290.0 | 110.0 | limb 1 (arm) total 240.3 is -27.7% from 332.5 |
...
- limb 3 (arm) total 370.2 is +11.3% from 332.5
- limb 3 upper arm 187.1 is +20.7% from 155.0
- limb 4 (arm) total 370.2 is +11.3% from 332.5
- limb 4 upper arm 187.1 is +20.7% from 155.0
- torso 250.0 is -51.2% from 512.1
- nearest-baseline classification gives 4 arm(s) and 0 leg(s)
...
- limb 1 (arm) total 235.0 is -29.3% from 332.5
- limb 1 upper arm 107.0 is -31.0% from 155.0
- limb 1 forearm 128.0 is -27.9% from 177.5
...
- limb 4 (arm) total 235.0 is -29.3% from 332.5
- limb 4 upper arm 107.0 is -31.0% from 155.0
- limb 4 forearm 128.0 is -27.9% from 177.5
...
### I
- limb 1 (arm) total 240.3 is -27.7% from 332.5
- limb 1 upper arm 130.2 is -16.0% from 155.0
- limb 1 forearm 110.0 is -38.0% from 177.5
- limb 2 (arm) total 240.3 is -27.7% from 332.5
- limb 2 upper arm 130.2 is -16.0% from 155.0
- limb 2 forearm 110.0 is -38.0% from 177.5
...
- limb 2 has 3 skeletal segments; expected upper/lower pair
- limb 3 (arm) total 369.1 is +11.0% from 332.5
- limb 3 upper arm 185.1 is +19.4% from 155.0
- limb 4 (arm) total 369.2 is +11.0% from 332.5
