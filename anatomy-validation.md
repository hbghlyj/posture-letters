...
| J | **FAIL** | L 250.3, L 250.3, L 376.7, L 403.9 | 332.0 | 110.0 | limb 1 (leg) total 250.3 is -15.2% from 295.2 |
| K | **FAIL** | L 294.0, L 290.0, L 308.3, L 338.0 | 92.1 | 110.0 | limb 2 thigh 143.0 is -5.8% from 151.8 |
| L | **FAIL** | A 216.3, A 216.3, L 594.0, L 566.8 | 242.0 | 110.0 | limb 1 (arm) total 216.3 is +9.3% from 197.8 |
...
| Z | **FAIL** | L 400.0, L 382.0, L 397.8, L 397.8 | 613.6 | 110.0 | limb 1 (leg) total 400.0 is +35.5% from 295.2 |
...
- limb 3 (leg) total 376.7 is +27.6% from 295.2
- limb 3 thigh 168.2 is +10.8% from 151.8
- limb 3 calf 208.4 is +45.3% from 143.5
- limb 4 (leg) total 403.9 is +36.8% from 295.2
- limb 4 thigh 168.3 is +10.9% from 151.8
- limb 4 calf 235.6 is +64.3% from 143.5
...
- limb 3 (leg) total 594.0 is +101.2% from 295.2
- limb 3 thigh 268.2 is +76.7% from 151.8
- limb 3 calf 325.8 is +127.1% from 143.5
- limb 4 (leg) total 566.8 is +92.0% from 295.2
- limb 4 thigh 268.2 is +76.7% from 151.8
- limb 4 calf 298.6 is +108.1% from 143.5
...
- limb 3 (leg) total 397.8 is +34.7% from 295.2
- limb 3 calf 240.6 is +67.7% from 143.5
- limb 4 (leg) total 397.8 is +34.7% from 295.2
- limb 4 thigh 184.5 is +21.6% from 151.8
- limb 4 calf 213.3 is +48.7% from 143.5
