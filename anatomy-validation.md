...
| D | **FAIL** | L 663.7, L 327.4, L 293.0 | 524.1 | 110.0 | expected 4 measurable limbs; found 3 |
...
| I | **FAIL** | L 240.3, L 240.3, L 340.1, L 340.1 | 290.0 | 110.0 | limb 1 (leg) total 240.3 is -19.7% from 299.2 |
| J | **FAIL** | L 266.5, A 84.0, L 282.4 | 898.4 | 110.0 | expected 4 measurable limbs; found 3 |
| K | **FAIL** | L 349.7, L 256.8, L 266.2, L 387.1 | 320.1 | 110.0 | limb 1 (leg) total 349.7 is +16.9% from 299.2 |
| L | **FAIL** | A 220.8, A 220.8, L 356.0, L 356.0 | 386.0 | 110.0 | limb 1 (arm) total 220.8 is +11.6% from 197.8 |
...
### I
- limb 1 (leg) total 240.3 is -19.7% from 299.2
- limb 1 thigh 130.2 is -15.2% from 153.7
- limb 1 calf 110.0 is -24.4% from 145.6
- limb 2 (leg) total 240.3 is -19.7% from 299.2
- limb 2 thigh 130.2 is -15.2% from 153.7
- limb 2 calf 110.0 is -24.4% from 145.6
- limb 3 (leg) total 340.1 is +13.7% from 299.2
- limb 3 thigh 170.1 is +10.7% from 153.7
- limb 3 calf 170.1 is +16.8% from 145.6
- limb 4 (leg) total 340.1 is +13.7% from 299.2
- limb 4 thigh 170.1 is +10.7% from 153.7
- limb 4 calf 170.1 is +16.8% from 145.6
- torso 290.0 is +78.1% from 162.8
- nearest-baseline classification gives 0 arm(s) and 4 leg(s)

### J
- expected 4 measurable limbs; found 3
- limb 1 (leg) total 266.5 is -10.9% from 299.2
- limb 1 thigh 136.5 is -11.2% from 153.7
- limb 1 calf 130.0 is -10.7% from 145.6
- limb 2 (arm) total 84.0 is -57.6% from 197.8
- limb 2 upper arm 41.2 is -63.4% from 112.7
- limb 2 forearm 42.7 is -49.8% from 85.1
- limb 3 (leg) total 282.4 is -5.6% from 299.2
- limb 3 thigh 134.6 is -12.4% from 153.7
- torso 898.4 is +451.8% from 162.8
...
### L
- limb 1 (arm) total 220.8 is +11.6% from 197.8
- limb 1 forearm 104.2 is +22.4% from 85.1
- limb 2 (arm) total 220.8 is +11.6% from 197.8
- limb 2 forearm 104.2 is +22.4% from 85.1
- limb 3 (leg) total 356.0 is +19.0% from 299.2
- limb 3 thigh 190.0 is +23.6% from 153.7
- limb 3 calf 166.0 is +14.0% from 145.6
- limb 4 (leg) total 356.0 is +19.0% from 299.2
- limb 4 thigh 190.0 is +23.6% from 153.7
- limb 4 calf 166.0 is +14.0% from 145.6
- torso 386.0 is +137.1% from 162.8
...
- limb 1 (leg) total 640.0 is +113.9% from 299.2
- limb 1 has 1 skeletal segments; expected upper/lower pair
- limb 2 (leg) total 640.0 is +113.9% from 299.2
