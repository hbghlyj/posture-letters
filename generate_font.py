...
class Drawer:
    ...
    def kneeling_foot(
        ...
        # Use the vectorized foot outline from FOOT_PROFILE.
        # Each point is (fraction_along_foot, height_from_ground) where
        # fraction is 0-1 from heel to toe, and height is 0-1 from ground to top.
        # This traces the complete anatomical foot silhouette for kneeling position.
        
        foot_outline = []
        
        # Start at ground level at the heel
        foot_outline.append((at(0.0), ground))
        
        # Trace the foot profile from the vectorized reference
